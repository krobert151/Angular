...
import { PlanetListResponse } from 'src/app/models/plante-list-interface/plante-list-interface.module';

const PLANETA_RESPONSE: PlanetListResponse = {
  count: 60,
...
@Component({
  ...
  styleUrls: ['./planet-list-component.component.css']
})


export class PlanetListComponentComponent {

  planetList = PLANETA_RESPONSE.results;
