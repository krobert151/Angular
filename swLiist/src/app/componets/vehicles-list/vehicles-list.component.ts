...
import { Vehicle, VehiclesResponse } from '../models/vehicles.interface';
...
export class VehiclesListComponent {
  ...
  VehiclesListComponets = VEHICLES;

  public getPhotoUrl(url: string) {

    var n = url.split('/').reverse()[1];
    return 'https://starwars-visualguide.com/assets/img/vehicles/' + n + '.jpg';
