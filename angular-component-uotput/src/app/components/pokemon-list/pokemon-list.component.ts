...
import { PokemonListResponse } from 'src/app/models/pokemon-list/pokemon-list.module';
const POKEMON_LIST: PokemonListResponse = {
  count: 1292, next: null, previous: null, results: [{ name: "bulbasaur", url: "https://pokeapi.co/api/v2/pokemon/1/" },
...
export class PokemonListComponent {
  ...
  PokemonList = POKEMON_LIST.results;
}
